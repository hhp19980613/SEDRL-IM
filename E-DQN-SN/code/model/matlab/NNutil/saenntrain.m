...
numbatches = floor(numbatches); %取一个比numbatches小的数
...
for epoch = 1 : numepochs
    ...
    for l = 1 : numbatches
        ...
        simlarMatrix=zeros(batchsize,batchsize);%生成一个零矩阵
        for a=1:batchsize
            for b=1:batchsize
                simlarMatrix(a,b)=network(batch_x_index(a),batch_x_index(b)) ;
            end
        end
        S = simlarMatrix;%相似性矩阵，A ？
